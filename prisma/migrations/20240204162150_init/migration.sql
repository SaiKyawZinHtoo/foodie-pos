...
-- AddForeignKey
ALTER TABLE "DisabledLocationMenuCategory" ADD CONSTRAINT "DisabledLocationMenuCategory_locattionId_fkey" FOREIGN KEY ("locattionId") REFERENCES "Location"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
